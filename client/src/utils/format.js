...
/** For <input type="datetime-local">, which insists on local time, no zone. */
...
/** "4 min", "1 h 12 min" - used for SOS durations. */
...
/** Deterministic pastel from a string, so an avatar keeps its colour. */
