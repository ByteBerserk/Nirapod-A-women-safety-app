...
/** FR-10: every past activation, with date, duration and location. */
...
export default function SosHistory() {
  ...
  const openDetail = async (id) => {
    try {
      // The list request omits the trail because it is large; fetching the
      // full record only when a row is opened keeps the list fast.
