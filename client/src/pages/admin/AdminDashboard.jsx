...
/** FR-24: the administrator's overview. */
...
export default function AdminDashboard() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      // A moderator can reach this page but cannot call the analytics
      // endpoints, so those are only requested for a full administrator.
  ...
  return (
    <>
      ...
      {/* Things that need a human. Shown first, because they are actionable. */}
...
/**
 * A hand-rolled SVG chart rather than a charting library. Recharts alone is
 * larger than the rest of this page, and three series of daily counts do not
 * need it.
 */
