...
export default function Login() {
  ...
  const update = (event) => {
    ...
    // Clearing as they type stops a stale message sitting under a fixed field.
  ...
  const submit = async (event) => {
    ...
    try {
      ...
      // NFR-14: keep what they typed. Retyping an email after a failed sign-in
      // is a small thing that feels like a big one.
