...
/** FR-20: the log of every enter/leave transition. */
const safePlaceEventSchema = new mongoose.Schema(
  {
    ...
    placeLabel: { type: String, default: '' }, // snapshot: the place may be renamed later
...
// The history screen only goes back 90 days; older rows expire on their own.
